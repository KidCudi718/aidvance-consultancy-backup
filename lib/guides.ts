...
export const guides: Guide[] = [
  ...
  },
  {
    ...
    eyebrow: "Your team",
    crumb: "Your team",
    dek: "The job only you can do is usually just a job only you have written down. A practical way to capture how the work really happens, by talking rather than typing.",
